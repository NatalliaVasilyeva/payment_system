...
//    }
    ...
    public static Transaction toTransaction(TopUpRequestDto dto, UUID merchantId) {
        return Transaction.builder()
            ...
            .notificationUrl(dto.notificationUrl())
            .cardNumber(dto.cardRequestDto().cardNumber())
            .cardExpirationDate(dto.cardRequestDto().expDate())
            .cardCvv(dto.cardRequestDto().cvv().getBytes(StandardCharsets.UTF_8))
            .language(dto.language())
            .customerFirstName(dto.customerRequestDto().firstName())
            .customerLastName(dto.customerRequestDto().secondName())
            .customerCountry(dto.customerRequestDto().country())
            .transactional(true)
            .notificationUrl(dto.notificationUrl())
            .build();
    }
